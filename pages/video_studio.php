                    ...
                    <div class="row">
                      <div class="col-6 stutio-video-section" style="min-width:510px;max-width:510px;">
                        <div class="studio-vid-container">
                          <video id="video" data-id="<?php echo $id; ?>" width="480" height="270.4" >
                      ...
                      <div class="col-6 stutio-video-property">
                        <div class="studio-thumbnail">
                          <img src="../res/img/thumbnail/<?php echo $id; ?>.jpg" style="height:100%;">
                        </div>
                        <div class="studio-thumbnail" >
                          <img src="../res/img/thumbnail/<?php echo $id; ?>.jpg" style="height:100%;">
                        </div>
                        ...
                        <form id="studio-edit-vid" method="post">
                          ...
                          <div class="row">
                            <div class="col-6 wow animated slideInLeft" data-wow-delay=".5s" style="margin-top: 25px;">
                              <input type="text" name="title" id="title" required="required" class="form" placeholder="Title" onchange="changeTitle()"  onkeyup="changeTitle()"/>
                              <textarea name="description" id="description" class="form textarea" placeholder="Description"></textarea>
                              <textarea name="tags" id="tags" class="form textarea" placeholder="Tags (semicolone separated)"></textarea>
                            </div>
                            <!-- End Left Inputs -->
                            <!-- Right Inputs -->
