...
<html>
  <head>
    ...
    <!-- Icon -->
      <link rel="icon" href="http://localhost/tulsicare/res/img/icon.png">
    <!-- End of Icon -->
    ...
    <!-- CSS -->
      ...
      <link rel="stylesheet" type="text/css" href="http://localhost/tulsicare/res/font/icon/flaticon.css">
    <!-- End of CSS -->

    <!-- JavaScript -->
      <script type="text/javascript" src="http://localhost/tulsicare/js/jquery-3.3.1.min.js"></script>
      <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"></script>
      <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/js/bootstrap.min.js"></script>
    <!-- End of JavaScript -->

    <!-- Color theme -->
      <link rel="stylesheet" href="http://localhost/tulsicare/css/style.css">
    <!-- End of Color Theme -->
    <!-- Script -->
    <script>
    ...
    <div class="container-fluid" style="height: 46px;">
      <div class="  col-md-8 col-5">
        <ul class="navbar-nav" style="flex-direction: row;">
          ...
          <!-- Tulsi LOGO -->
          <li class="nav-item">
            <a class="navbar-brand" href="http://localhost/tulsicare/" style="margin-right:5px;">
              <img src="http://localhost/tulsicare/res/img/icon.png" alt="Logo" style="width:1.8em;margin-left:1em;">
            </a>
          </li>
          <!-- End of Tulsi LOGO -->
          <!-- Tulsi Title -->
          <li class="nav-item">
            <a class="navbar-brand" id="brand-title" href="http://localhost/tulsicare/">Tulsi Care</a>
          </li>
          <!-- End of Tulsi Tulsi -->
          <!-- Search Bar -->
      ...
      <!-- Links -->
        <div class="  col-md-4 col-7" style="padding: 0px;">
          <ul class="navbar-nav " id="links" style="float:right; flex-direction: row;" >
            ...
            <li class="nav-item">
              <a class="navbar-brand dark-icon no-pad-l no-pad-r" href="http://localhost/tulsicare/pages/upload_video.php">
